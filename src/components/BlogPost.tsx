...
const BlogPost: React.FC<BlogPostProps> = ({
  ...
  const currentUrl = `https://www.daikonvegansushi.com${url}`;

  return (

      <div className="blog-container" role="region" aria-labelledby="blog-article-heading">
        ...
        <article className="blog-article">
          <header className="blog-header">
            <h1 id="blog-article-heading" className="blog-title">
              {title}
            </h1>
